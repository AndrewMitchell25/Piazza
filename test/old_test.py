...
if __name__ == '__main__':
    ...
    test_post()
    print("\tCreated a new post: ", test_get())
    first_ID = test_get()[0]['_id']
    print("\tID of new first post: ", first_ID)
    print("\tGet the new first post by ID: ", test_get_id(first_ID))
    test_patch(first_ID, "New Title", "tech", "New Message")
    print("\tEdited the new first post: ", test_get())
    test_delete_id(first_ID)
    print("\tDeleted the new first post: ", test_get())
    test_delete()
